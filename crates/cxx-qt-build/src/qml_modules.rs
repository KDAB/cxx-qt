...
impl QmlModule {
    ...
    ///
    /// Additional resources such as images can be added to the Qt resources for the QML module by
    /// using the [crate::CxxQtBuilder::qrc_resources] or [crate::CxxQtBuilder::qrc] functions.
    ///
