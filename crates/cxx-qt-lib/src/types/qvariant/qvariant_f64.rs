...
pub mod ffi {
    ...
    unsafe extern "C++" {
        ...
        #[rust_name = "value_or_default_f64"]
        fn qvariantValueOrDefault(variant: &QVariant) -> f64;
    }
}
...
pub(crate) fn value_or_default(variant: &ffi::QVariant) -> f64 {
    ffi::value_or_default_f64(variant)
}
