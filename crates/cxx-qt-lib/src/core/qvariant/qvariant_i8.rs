...
pub mod ffi {
    ...
    unsafe extern "C++" {
        ...
        #[rust_name = "value_or_default_i8"]
        fn qvariantValueOrDefault(variant: &QVariant) -> i8;
    }
}
...
pub(crate) fn value_or_default(variant: &ffi::QVariant) -> i8 {
    ffi::value_or_default_i8(variant)
}
