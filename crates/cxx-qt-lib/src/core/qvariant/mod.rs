...
impl_qvariant_value!(crate::QHash<crate::QHashPair_QString_QVariant>, qvariant_qvarianthash);
impl_qvariant_value!(crate::QList<QVariant>, qvariant_qvariantlist);
impl_qvariant_value!(crate::QMap<crate::QMapPair_QString_QVariant>, qvariant_qvariantmap);
