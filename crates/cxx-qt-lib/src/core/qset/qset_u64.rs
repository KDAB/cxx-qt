...
pub mod ffi {
    ...
    unsafe extern "C++" {
        ...
        #[rust_name = "qset_clone_u64"]
        fn construct(_: &QSet_u64) -> QSet_u64;
        #[rust_name = "qset_default_u64"]
        fn construct() -> QSet_u64;
        #[rust_name = "qset_drop_u64"]
