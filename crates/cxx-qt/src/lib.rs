...
///
/// If locking is disabled the [Threading] trait can not be enabled on the object.
///
...
///     }
///
///     unsafe impl !cxx_qt::Locking for MyStruct {}
/// }
///
/// #[derive(Default)]
...
///
/// Ensure that the `cxx_qt::Constructor<()>` is implemented for the QObject
///
/// # Example
///
/// ```rust,ignore
...
pub fn write_headers(directory: impl AsRef<Path>) {
    ...
    for (file_contents, file_name) in [
        ...
        (
            include_str!("../include/maybelockguard.h"),
            "maybelockguard.h",
        ),
        (
