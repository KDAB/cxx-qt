...
"#
        ...
        let qmltyperegistrar_cpp_output = PathBuf::from(&format!(
        ...
        ));
        {
            let mut args = vec![
                ...
                uri.to_string(),
                "-o".to_string(),
                qmltyperegistrar_cpp_output.to_string_lossy().to_string(),
            ];
            args.extend(
                metatypes_json
                    .iter()
...
"#
        ...
        QmlModuleRegistrationFiles {
            ...
            qmltyperegistrar: qmltyperegistrar_cpp_output,
            qmltypes: qmltypes_path.into(),
            qmldir: qmldir_file_path.into(),
