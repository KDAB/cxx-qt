...
impl Initializer {
    ...
    pub fn default_signature(name: &str) -> Self {
        Self {
            ...
            init_declaration: Some(format!("extern \"C\" int {name}();")),
        }
    }
}
...
"#
    ...
    pub fn qrc(&mut self, input_file: &impl AsRef<Path>) -> Initializer {
        ...
        Initializer {
            ...
            // TODO: This cannot handle QT_NAMESPACE!
            init_call: Some(format!("qInitResources_{name}();")),
            init_declaration: Some(format!("int qInitResources_{name}();")),
        }
    }
