...
Note that when they are used as a parameter type in invokables they should be passed as a reference, eg `color: &QColor`, and when they are a property, or return type, or signal they should be a value, eg `UniquePtr<QColor>`.
